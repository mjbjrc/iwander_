                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12">
                        ...
                        @foreach ($categories as $category)
                            <div class="form-check form-check-inline">
                                <input type="checkbox" class="form-check-input" name="categories[]" id="categories" value="{{$category->id}}" {{ (in_array($category->id, $category_attraction_ids)) ? "checked":""}}  />
                    ...
                    <div class="form-group col-12">
                        ...
                        @foreach ($keywords as $keyword)
                            <div class="form-check form-check-inline">
                              <input type="checkbox" class="form-check-input" name="keywords[]" value="{{$keyword->id}}" {{ (in_array($keyword->id, $keyword_attraction_ids)) ? "checked":"" }} />
